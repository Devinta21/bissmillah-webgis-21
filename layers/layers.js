...
var format_Reprojectedpendidikan_6 = new ol.format.GeoJSON();
var features_Reprojectedpendidikan_6 = format_Reprojectedpendidikan_6.readFeatures(json_Reprojectedpendidikan_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Reprojectedpendidikan_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Reprojectedpendidikan_6.addFeatures(features_Reprojectedpendidikan_6);
var lyr_Reprojectedpendidikan_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Reprojectedpendidikan_6, 
                style: style_Reprojectedpendidikan_6,
                popuplayertitle: 'Reprojected pendidikan',
                interactive: true,
                title: '<img src="styles/legend/Reprojectedpendidikan_6.png" /> Reprojected pendidikan'
            });

lyr_Positron_0.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_1.setVisible(true);lyr_JALAN_LN_25K_2.setVisible(true);lyr_Buffered_3.setVisible(true);lyr_Servicearealines_4.setVisible(true);lyr_PENDIDIKAN_PT_25K_5.setVisible(true);lyr_Reprojectedpendidikan_6.setVisible(true);
var layersList = [lyr_Positron_0,lyr_ADMINISTRASIDESA_AR_25K_1,lyr_JALAN_LN_25K_2,lyr_Buffered_3,lyr_Servicearealines_4,lyr_PENDIDIKAN_PT_25K_5,lyr_Reprojectedpendidikan_6];
...
lyr_Buffered_3.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'KATPDK': 'KATPDK', 'JLPDDK': 'JLPDDK', 'FGGPDK': 'FGGPDK', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'JJGPDF': 'JJGPDF', 'JNSPDL': 'JNSPDL', 'type': 'type', 'start': 'start', });
lyr_Servicearealines_4.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'KATPDK': 'KATPDK', 'JLPDDK': 'JLPDDK', 'FGGPDK': 'FGGPDK', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'JJGPDF': 'JJGPDF', 'JNSPDL': 'JNSPDL', 'type': 'type', 'start': 'start', });
...
lyr_Reprojectedpendidikan_6.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'KATPDK': 'KATPDK', 'JLPDDK': 'JLPDDK', 'FGGPDK': 'FGGPDK', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'JJGPDF': 'JJGPDF', 'JNSPDL': 'JNSPDL', });
...
lyr_Buffered_3.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'KATPDK': 'TextEdit', 'JLPDDK': 'TextEdit', 'FGGPDK': 'TextEdit', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'JJGPDF': 'TextEdit', 'JNSPDL': 'TextEdit', 'type': 'TextEdit', 'start': 'TextEdit', });
lyr_Servicearealines_4.set('fieldImages', {'NAMOBJ': '', 'LUAS': '', 'KATPDK': '', 'JLPDDK': '', 'FGGPDK': '', 'REMARK': '', 'FCODE': '', 'SRS_ID': '', 'LCODE': '', 'METADATA': '', 'JJGPDF': '', 'JNSPDL': '', 'type': '', 'start': '', });
...
lyr_Reprojectedpendidikan_6.set('fieldImages', {'NAMOBJ': '', 'LUAS': '', 'KATPDK': '', 'JLPDDK': '', 'FGGPDK': '', 'REMARK': '', 'FCODE': '', 'SRS_ID': '', 'LCODE': '', 'METADATA': '', 'JJGPDF': '', 'JNSPDL': '', });
...
lyr_Buffered_3.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'no label', 'KATPDK': 'no label', 'JLPDDK': 'no label', 'FGGPDK': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'JJGPDF': 'no label', 'JNSPDL': 'no label', 'type': 'no label', 'start': 'no label', });
lyr_Servicearealines_4.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'no label', 'KATPDK': 'no label', 'JLPDDK': 'no label', 'FGGPDK': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'JJGPDF': 'no label', 'JNSPDL': 'no label', 'type': 'no label', 'start': 'no label', });
...
lyr_Reprojectedpendidikan_6.set('fieldLabels', {'NAMOBJ': 'header label - visible with data', 'LUAS': 'no label', 'KATPDK': 'no label', 'JLPDDK': 'no label', 'FGGPDK': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'JJGPDF': 'no label', 'JNSPDL': 'no label', });
lyr_Reprojectedpendidikan_6.on('precompose', function(evt) {
